 ...
 * @author user
 */
public class REGISTRACTION extends javax.swing.JFrame {

    /**
     * Creates new form REGISTRACTION
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(REGISTRACTION.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new REGISTRACTION().setVisible(true);
            }
        });
    }
